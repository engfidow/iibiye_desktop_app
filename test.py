...
class SelfCheckoutSystem(ctk.CTk):
    ...
    def delete_item(self, uid):
        if messagebox.askyesno("Confirm Delete", "Are you sure you want to delete this item?"):
            ...
            self.display_cart()  # Refresh cart display
    ...
    def display_cart(self):
        ...
        def on_touch_scroll(event):
            if hasattr(on_touch_scroll, 'last_y'):
        ...
        self.bind_all("<Button-4>", lambda event: canvas.yview_scroll(-1, "units"))
        self.bind_all("<Button-5>", lambda event: canvas.yview_scroll(1, "units"))

        self.widgets_to_clear.append(canvas)
        self.widgets_to_clear.append(scrollbar)
        self.widgets_to_clear.append(scrollable_frame)
        ...
        for product in self.cart:
            ...
            self.widgets_to_clear.append(row_frame)
            ...
            self.widgets_to_clear.append(image_label)
            ...
            self.widgets_to_clear.append(delete_button)
            ...
            self.widgets_to_clear.append(price_label)
            ...
            self.widgets_to_clear.append(name_label)

        canvas.pack(side="right", fill="both", expand=True)
        scrollbar.pack(side="right", fill="y")

        total_price = sum(p['sellingPrice'] for p in self.cart)
